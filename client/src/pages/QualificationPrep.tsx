...
function RegisterInterestModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-md bg-[#0d1626] border border-border rounded-2xl p-8 shadow-2xl">
        <button
          onClick={onClose}
          className="absolute top-4 right-4 text-foreground/30 hover:text-white transition-colors"
          aria-label="Close"
        >
          <X className="h-5 w-5" />
        </button>
        ...
        {submitted ? (
          <div className="text-center py-6 space-y-4">
            ...
            <h2 className="text-2xl font-black text-foreground">You're on the list.</h2>
          ...
          <>
            <h2 className="text-2xl font-black text-foreground mb-1">Register your interest</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-xs text-foreground/50 uppercase tracking-widest mb-1.5">
                  First Name
                </label>
                <input
                  type="text"
                  ...
                  className="w-full px-4 py-3 bg-white/5 border border-border rounded-lg text-foreground placeholder:text-foreground/25 focus:outline-none focus:border-cyan-400/50 transition-colors text-sm"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-white/5 border border-border rounded-lg text-foreground focus:outline-none focus:border-cyan-400/50 transition-colors text-sm appearance-none"
                >
      ...
      >
        ...
        <header className="flex items-center justify-between px-6 md:px-12 pt-7 flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            />
            <span className="text-foreground/50 text-sm font-medium">APM Academy</span>
          </div>
          <Button
            onClick={() => setLocation("/login")}
            variant="outline"
            className="border-border/70 text-foreground/70 hover:text-white hover:border-white/40 bg-transparent text-sm px-5"
          >
            Sign In
          </Button>
        </header>
        ...
        <main className="flex-1 flex flex-col items-center justify-center text-center px-6 gap-8">
          ...
          <div className="space-y-3 max-w-2xl">
            ...
            <p className="text-foreground/50 text-lg md:text-xl font-light max-w-lg mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3">
            ...
            <Button
              ...
              variant="outline"
              className="border-border/70 text-foreground/70 hover:text-white hover:border-white/40 bg-transparent px-8 py-3 text-base h-auto"
            >
              Register Interest
            </Button>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-12 mt-2">
            {[
              ...
              <div key={label} className="flex flex-col items-center gap-2">
                ...
                <span className="text-foreground/50 text-xs font-medium tracking-wide">{label}</span>
              </div>
            ))}
          </div>
        </main>
  ...
  return (
    <div className="min-h-screen bg-[#080e1a] text-white">
      <div className="max-w-4xl mx-auto px-4 py-10 space-y-10">
          ...
          <div className="bg-emerald-500/[0.04] border border-emerald-500/20 rounded-2xl p-6 space-y-5">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-foreground/50 text-sm">Project Fundamentals Qualification</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-muted/60 rounded-lg p-3 text-center">
                ...
                <div className="text-xs text-foreground/40 mt-0.5">Modules</div>
              </div>
              <div className="bg-muted/60 rounded-lg p-3 text-center">
                <div className="text-xl font-black text-emerald-300">~{pfq?.estimatedHours ?? 12}h</div>
                <div className="text-xs text-foreground/40 mt-0.5">Study Time</div>
              </div>
            </div>
            ...
            <Button
              ...
              className="w-full bg-emerald-600 hover:bg-emerald-500 text-foreground font-bold"
            >
          ...
          <div className="bg-blue-500/[0.04] border border-blue-500/20 rounded-2xl p-6 space-y-5">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-foreground/50 text-sm">Project Management Qualification</p>
              </div>
            </div>
        ...
        <div className="bg-muted/60 border border-border rounded-2xl p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-start gap-4">
            <div className="w-11 h-11 bg-cyan-400/10 rounded-xl flex items-center justify-center flex-shrink-0">
              <Download className="h-5 w-5 text-cyan-400" />
            </div>
            <div>
              <h3 className="font-bold text-foreground">Full Question Bank PDF</h3>
        ...
        <div className="space-y-3">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              ...
              <div
                key={step.title}
                className="bg-muted/60 border border-border rounded-xl p-4 space-y-2"
              >
